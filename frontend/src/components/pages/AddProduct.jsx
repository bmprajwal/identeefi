...
const AddProduct = () => {
	...
	useEffect(() => {
		Geocode.setApiKey("AIzaSyBkk1Ccw0Pl4AnbXuEBrrc1-gKJuYNzOgM");
	...
	const downloadQR = () => {
		...
		canvas.toBlob(function (blob) {
			...
			downloadLink.download = `${serialNumber}.png`; // Download the image with the correct file name
	...
	const checkUnique = async () => {
		const res = await axios.get(
			"http://localhost:5000/product/serialNumber"
		);
			...
			>
				...
				<form onSubmit={handleSubmit}>
					<TextField
						...
						error={!isUnique}
						helperText={
							!isUnique ? "Serial Number already exists" : ""
						}
						id="outlined-basic"
						margin="normal"
						label="Serial Number"
